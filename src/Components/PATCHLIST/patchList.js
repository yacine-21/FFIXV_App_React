      ...
      <div className={styles.container}>
        ...
        {click === false ? (
          <button
            ...
            onClick={onClickHandlerPatchList}
          >
            SHOW PATCHLIST
          </button>
        ) : null}
        <div className={styles.resultPatchList}>
          {click === true
            ? result === undefined
              ? null
              : result.map((patchlistRes) => {
                  return (
                    <div key={patchlistRes.ID}>
                      <Card className={styles.card}>
                        <Card.Img
                          className={styles.miniature}
                          src={patchlistRes.Banner}
                        />
                        <Card.Body className={styles.bodyCard}>
                          ...
                          {patchlistRes.PatchNotes_en === "" ||
                          patchlistRes.PatchNotes_en === undefined ? null : (
                            <Button className={styles.buttonCard}>
                              <a
                                className={styles.a}
                                target="blank"
                                href={patchlistRes.PatchNotes_en}
                              >
                                GO TO
                              </a>{" "}
                            </Button>
        ...
        {click === true ? (
          <button
            className={styles.buttonCardShow}
            onClick={onClickHandlerPatchListFalse}
          >
            HIDE PATCHLIST
          </button>
        ) : null}
